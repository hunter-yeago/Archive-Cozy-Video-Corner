...
export function Sidebar(props) {
    ...
    return (
        <div className='outerverticalcontainer'>
            ...
            <button className={props.tab === "search" ?  'searchactivebarbutton' : 'barbutton'}  
                id="search" 
            ...
            <button className={props.tab === "info" ?  'infoactivebarbutton' : 'barbutton'}  id="info" onClick={props.handler.bind(this)}>
